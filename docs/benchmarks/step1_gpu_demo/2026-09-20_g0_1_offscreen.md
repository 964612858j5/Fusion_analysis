...
- Raw data: [2026-09-20_g0_1_offscreen.json](2026-09-20_g0_1_offscreen.json)
...
- PyOpenGL: `3.1.10` from `/tmp/block01-g0-1-pyopengl-VHAK3a/lib/python3.10/site-packages/OpenGL/__init__.py`
- Qt platform: `offscreen`
- GL_VENDOR / GL_RENDERER: `NVIDIA Corporation` / `NVIDIA GeForce RTX 4090/PCIe/SSE2`
- GL_VERSION / GLSL: `4.6.0 NVIDIA 535.309.01` / `4.60 NVIDIA`
...
- `desktop_presentation`: **not passed**
